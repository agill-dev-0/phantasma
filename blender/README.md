...
### Design Log:
1) The raw triangle count for the medallion comes out to be well over 3 million! Need to redo the design with geometry awareness to reduce the triangle count.
